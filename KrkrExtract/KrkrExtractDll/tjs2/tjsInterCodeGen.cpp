...
//---------------------------------------------------------------------------
const tjs_char* tTJSInterCodeContext::GetContextTypeNameEnd() const
{
	switch(ContextType)
	{
	case ctTopLevel:		return TJS_W(".code.end.top_level_script");
	case ctFunction:		return TJS_W(".code.end.function");
	case ctExprFunction:	return TJS_W(".code.end.function_expression");
	case ctProperty:		return TJS_W(".code.end.property");
	case ctPropertySetter:	return TJS_W(".code.end.property_setter");
	case ctPropertyGetter:	return TJS_W(".code.end.property getter");
	case ctClass:			return TJS_W(".code.end.class");
	case ctSuperClassGetter:return TJS_W(".code.end.super_class_getter_proxy");
	default:				return TJS_W(".code.end.unknown");
	}
}

const tjs_char* tTJSInterCodeContext::GetContextTypeNameBegin() const
{
	switch (ContextType)
	{
	case ctTopLevel:		return TJS_W(".code.begin.top_level_script");
	case ctFunction:		return TJS_W(".code.begin.function");
	case ctExprFunction:	return TJS_W(".code.begin.function_expression");
	case ctProperty:		return TJS_W(".code.begin.property");
	case ctPropertySetter:	return TJS_W(".code.begin.property_setter");
	case ctPropertyGetter:	return TJS_W(".code.begin.property_getter");
	case ctClass:			return TJS_W(".code.begin.class");
	case ctSuperClassGetter:return TJS_W(".code.begin.super class_getter_proxy");
	default:				return TJS_W(".code.begin.unknown");
	}
}
